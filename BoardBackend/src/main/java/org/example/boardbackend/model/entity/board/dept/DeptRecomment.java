 ...
 */
@Entity
@Table(name = "LOTTO_DEPT_BOARD_RECOMMENT")
@SequenceGenerator(
        name = "SQ_DEPT_BOARD_RECOMMENT_GENERATOR"
        , sequenceName = "SQ_DEPT_BOARD_RECOMMENT"
        , initialValue = 1
        , allocationSize = 1
)
@Getter
...
@DynamicInsert
@DynamicUpdate
public class DeptRecomment extends BaseTimeEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE
            , generator = "SQ_DEPT_BOARD_RECOMMENT_GENERATOR"
    )
