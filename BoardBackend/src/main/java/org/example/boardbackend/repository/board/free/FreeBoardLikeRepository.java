...
public interface FreeBoardLikeRepository extends JpaRepository<FreeBoardLike, Long> {
    ...
    boolean existsByFreeBoardIdAndUserId(long freeBoardId, String userId);

    FreeBoardLike findByUserIdAndFreeBoardId(String userId, long freeBoardId); // 좋아요 상태 조회용 메소드 추가
